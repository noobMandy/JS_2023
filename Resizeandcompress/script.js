...
inputImg=document.getElementById("imgInp"),
...
const loadFile=(e)=>{
    ...
    previewImg.addEventListener("load",()=>{ //once img loaded
        ...
        heightInput.value=previewImg.naturalHeight;//natural width and natural height returns the original width and height of image
...
//1.0 is 100% quality where 0.7 is 70% of total. you can pass from 0.1 -1.0
    ...
    //setting the canvas height and width according to input values
