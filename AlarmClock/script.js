const currentTime = document.querySelector("h1"),
  ...
  selectedMenu = document.querySelectorAll("select");
...
function setAlarm() {
  if (isAlamSet) {
    ...
    return isAlamSet = false; // return isAlamSet value to false
  }
  //getting hour, minute,,ampm select tag value
  let time = `${selectedMenu[0].value}:${selectedMenu[1].value} ${selectedMenu[2].value}`;
